	...
	public boolean setCellData(String sheetName,String colName,int rowNum, String data){
        ...
        font.setFontName("Calibri");
		 ...
		 if(data.equals("PASS")) {
			 ...
			 //style.setFillPattern(CellStyle.SOLID_FOREGROUND);
			 XSSFColor colorGreen = new XSSFColor(java.awt.Color.green);
			 font.setColor(colorGreen);
			    //style.setFillForegroundColor(colorGrey);
			 //cellStyle.setFillForegroundColor(grey);
				//style.setFillForegroundColor(blue);
		 }
		 if(data.equals("FAIL")) {
			 XSSFColor colorRed = new XSSFColor(java.awt.Color.red);
			 font.setColor(colorRed);
		 }
		 else if (data.equals("SKIP")){
			 XSSFColor colorRed = new XSSFColor(java.awt.Color.blue);
			 font.setColor(colorRed);
		 }
